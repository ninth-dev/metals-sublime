...
__all__ = [
    ...
    'LspMetalsFindInDependencyCommand',
    'LspMetalsFocusViewCommand',
    'LspMetalsGoto',
    'LspMetalsMetalsGotoLocationCommand',
...
if package_name != "LSP-metals":
    ...
    from .commands.lsp_metals_focus import ActiveViewListener
    from .commands.lsp_metals_focus import LspMetalsFocusViewCommand
